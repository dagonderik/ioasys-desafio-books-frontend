...
const Cards = ({authors, title, pageCount, publisher, published, imageUrl}) => {
    return (
        <div className= 'card tc white dib br3 pa3 ma2 pointer grow shadow-5 card' style={{height: "200px", width: "400px",textAlign: "left", margin: "10px"}}  >
