  ...
  return (
    <div id="bookList">
      ...
      >
        ...
        <div>
          <p className="f4 b black">
            INFORMAÇÕES
            <br />
          </p>
          <p style={{ display: "flex", justifyContent: "space-between" }}>
            <b>Páginas</b> {bookList[route].pageCount}
          </p>
          <p style={{ display: "flex", justifyContent: "space-between" }}>
            <b>Editora</b> {bookList[route].publisher}
          </p>
          <p style={{ display: "flex", justifyContent: "space-between" }}>
            <b>Publicação</b> {bookList[route].published}
          </p>
          <p style={{ display: "flex", justifyContent: "space-between" }}>
            <b>Idioma</b> {bookList[route].language}
          </p>
          <p style={{ display: "flex", justifyContent: "space-between" }}>
            <b>Título Original</b> {bookList[route].title}
          </p>
          <p style={{ display: "flex", justifyContent: "space-between" }}>
            <b>ISBN-10</b> {bookList[route].isbn10}
          </p>
          <p style={{ display: "flex", justifyContent: "space-between" }}>
            <b>ISBN-13</b> {bookList[route].isbn13}
          </p>

          <p className="f4 b black">RESENHA DA EDITORA</p>
          <p className="f5" style={{ position: "absolute" }}>
            {bookList[route].description}
          </p>
        </div>
      </div>
    </div>
